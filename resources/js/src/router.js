  ...
  routes: [
    ...
    // =============================================================================
      ...
      children: [
        ...
        {
          path: '/apps/product/product-edit/:userId',
        ...
        {
          path: '/apps/product/product-add',
          // path: '/apps/product/product-add/:userId',
        ...
        {
          path: '/apps/product/product-view/:userId',
        ...
        },
        {
          ...
          component: () => import('@/views/apps/product/ProductListView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Product' },
        ...
        {
          path: '/apps/order/order-edit/:userId',
          name: 'app-order-edit',
        ...
        {
          path: '/apps/order/order-view/:userId',
          name: 'app-order-view',
          component: () => import('@/views/apps/order/OrderView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Order' },
        ...
        },
        {
          ...
          name: 'app-order-list',
          component: () => import('@/views/apps/order/OrderListView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Order' },
        ...
        {
          path: '/apps/category/category-edit/:userId',
        ...
        {
          path: '/apps/category/category-add/:userId',
          name: 'app-category-add',
          component: () => import('@/views/apps/category/category-add/CategoryAdd.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Category' },
        ...
        {
          path: '/apps/category/category-view/:userId',
        ...
        },
        {
          ...
          component: () => import('@/views/apps/category/CategoryListView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Category' },
        ...
        {
          path: '/apps/customer/customer-edit/:userId',
          name: 'app-customer-edit',
          component: () => import('@/views/apps/customer/customer-edit/CustomerEdit.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Customer' },
        ...
        {
          path: '/apps/customer/customer-add/:userId',
          name: 'app-customer-add',
          component: () => import('@/views/apps/customer/customer-add/CustomerAdd.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Customer' },
        ...
        {
          path: '/apps/customer/customer-view/:userId',
          name: 'app-customer-view',
          component: () => import('@/views/apps/customer/CustomerView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Customer' },
        ...
        },
        {
          ...
          component: () => import('@/views/apps/customer/CustomerListView.vue'),
          meta: {
            breadcrumb: [
              { title: 'Home', url: '/' },
              { title: 'Customer' },
