    ...
    <vx-card v-if="user_data">
      ...
      <div slot="no-body" class="tabs-container px-6 pt-6">
        ...
        <vs-tabs v-model="activeTab" class="tab-action-btn-fill-conatiner">
          <vs-tab label="Edit Order" icon-pack="feather" icon="icon-user">
            <div class="tab-text">
...
<script>
import OrderEditTabAccount     from './OrderEditTabAccount.vue'
import OrderEditTabInformation from './OrderEditTabInformation.vue'
import OrderEditTabSocial      from './OrderEditTabSocial.vue'
